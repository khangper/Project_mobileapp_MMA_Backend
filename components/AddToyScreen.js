  ...
  const AddToyScreen = ({ navigation }) => {
    ...
    const handleAddToy = async () => {
      ...
      const requiredFields = [name, category, description, imageUrl, priceDay, priceWeek, priceFortnite, inventoryCount];
      ...
      try {
        ...
        const toyData = {
          ...
          fixedPrice: saleOption === 'rentAndSale' ? parseFloat(fixedPrice) : null,
          availability,
          is_rentable: true,
