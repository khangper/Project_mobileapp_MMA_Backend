...
//         Alert.alert(
//           "Error",
//           "Failed to fetch shopping cart. Please try again later."
//         );
//       }
//     } finally {
//       setLoading(false);
...
//         <Text style={styles.itemPrice}>Price/Day: ${item.toy.price.day}</Text>
//         <Text style={styles.itemDetails}>Quantity: {item.quantity}</Text>
//         <Text style={styles.itemDetails}>Duration: {item.rent_duration}</Text>
//       </View>
//       <TouchableOpacity
...
const ShoppingCartScreen = () => {
  ...
  const renderItem = ({ item }) => {
    // Determine the price based on rent_duration
    const price =
      item.rent_duration === "day"
        ? item.toy.price.day
        : item.rent_duration === "week"
        ? item.toy.price.week
        : item.toy.price.twoWeeks;
      ...
      <View style={styles.cartItem}>
        ...
        <View style={styles.itemInfo}>
          ...
          <Text style={styles.itemPrice}>
            Price ({item.rent_duration}): ${price}
          </Text>
          <Text style={styles.itemDetails}>Quantity: {item.quantity}</Text>
        </View>
        <TouchableOpacity
